...
const UserCompletedTask = ({completedTasks} : {completedTasks: Task[] | undefined}) => {
  ...
  <div className=" flex flex-row overflow-y-scroll">
    {completedTasks.map((task: {id: string, name: string, points: number, societyId: string | null;}, index) => {
      return (
